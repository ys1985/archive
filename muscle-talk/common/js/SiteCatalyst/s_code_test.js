...
if(document.URL.match(/gmobb/i)){
	...
	if (s.events.match(/purchase/i)){s.eVar16 = s.prop16;}

	if (s.events.match(/purchase/i) && s.prop16 == 'flo'){s.events=s.events+',event41';}
	if (s.events.match(/purchase/i) && s.prop16 == 'eao'){s.events=s.events+',event42';}
	if (s.events.match(/purchase/i) && s.prop16 == 'mbo'){s.events=s.events+',event43';}
	if (s.events.match(/purchase/i) && s.prop16 == 'ipo'){s.events=s.events+',event44';}
	if (s.events.match(/purchase/i) && s.prop16 == 'wmo'){s.events=s.events+',event45';}
