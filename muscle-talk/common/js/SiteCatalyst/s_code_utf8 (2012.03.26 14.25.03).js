...
if(document.URL.match(/gmobb/i)){
	...
	/* pid Tracking */
	s.prop2 = s.eVar2
	if(s.eVar2){s.setCookie(s.eVar2,"gmoingmobb_evar2",0);}
	s.prop3="["+s.getCookie("gmoingmobb_evar2")+"]"+s.prop50;
	if(s.pageName){s.prop3="["+s.getCookie("gmoingmobb_evar2")+"]"+s.pageName;}
	
	/* sid Tracking */
	if(s.eVar42){s.setCookie(s.eVar42,"gmoingmobb_evar42",0);}
	
	
//	if(s.events.match(/25/))	{if(s.getCookie("gmoingmobb_evar2").match(/kpn/)){s.events='event26';}}
//	if(s.events.match(/15/))	{if(s.getCookie("gmoingmobb_evar2").match(/kpn/)){s.events='purchase,event16';}}
//	if(s.events.match(/25/))	{if(s.getCookie("gmoingmobb_evar2").match(/kkk/)){s.events='event27';}}
//	if(s.events.match(/15/))	{if(s.getCookie("gmoingmobb_evar2").match(/kkk/)){s.events='purchase,event17';}}
