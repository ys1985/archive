...
$(function() {
	...
	var imgrotate = "/common/images/img-rotate_01.png";
	var imgrotatemove = "/common/images/img-rotate_02.png";
	var rotateInfi = null;
	...
	subPanel.find("a").click(function(e) {
		...
		if(pid === "btnSubStamp") {
			...
			block.show();
			blockOpacity.show();
			blockImg[0].src = "/common/images/" + blockImgs[Math.floor(Math.random() * blockImgs.length)];
